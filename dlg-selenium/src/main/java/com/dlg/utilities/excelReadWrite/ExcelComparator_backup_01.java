 ...
 * </pre>
 */
public class ExcelComparator_backup_01 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Workbook wb1 = WorkbookFactory.create(new FileInputStream("C:\\ExcelUtility\\testData.xlsx"));
        Workbook wb2 = WorkbookFactory.create(new FileInputStream("C:\\ExcelUtility\\testData02.xlsx"));

        for (String d : ExcelComparator_backup_01.compare(wb1, wb2)) {
    ...
    public static List<String> compare(Workbook wb1, Workbook wb2) {
        ...
        ExcelComparator_backup_01 excelComparator = new ExcelComparator_backup_01();
