...
public class ExcelComparator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Workbook wb1 = WorkbookFactory.create(new FileInputStream("C:\\ExcelUtility\\TestData_01.xlsx"));
        Workbook wb2 = WorkbookFactory.create(new FileInputStream("C:\\ExcelUtility\\TestData_02.xlsx"));
