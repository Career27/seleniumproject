 ...
 * </pre>
 */
public class ExcelComparator_backup_02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Workbook wb1 = WorkbookFactory.create(new FileInputStream("C:\\ExcelUtility\\SKR-Test-05061045-FTSE 350-GBP-20190331-Default Excel Report_Expectedl01.xlsx"));
        Workbook wb2 = WorkbookFactory.create(new FileInputStream("C:\\ExcelUtility\\SKR-Test-05061045-FTSE 350-GBP-20190331-Default Excel Report_Actual01.xlsx"));
...
//        Style.setFillForegroundColor(IndexedColors.GREEN.getIndex());
        ...
        for (String d : ExcelComparator_backup_02.compare(wb1, wb2)) {
    ...
    public static List<String> compare(Workbook wb1, Workbook wb2) {
        ...
        ExcelComparator_backup_02 excelComparator = new ExcelComparator_backup_02();
